...
# ── /api/res/districts ──────────────────────────────────────
@router.get("/res/districts", dependencies=[Depends(require_permission("atlas"))])
async def get_res_districts(senaryo: str = Query(default="varsayilan")):
    key = cache_key("res_districts", senaryo)
...
# ── /api/res/polygons ───────────────────────────────────────
@router.get("/res/polygons", dependencies=[Depends(require_permission("atlas"))])
...
# ── /api/res/stats ──────────────────────────────────────────
@router.get("/res/stats", dependencies=[Depends(require_permission("atlas"))])
async def get_res_stats(senaryo: str = Query(default="varsayilan")):
    key = cache_key("res_stats", senaryo)
...
# ── /api/res/district/{ilce_adi} ────────────────────────────
@router.get("/res/district/{ilce_adi}", dependencies=[Depends(require_permission("raporlar"))])
async def get_res_district(ilce_adi: str, senaryo: str = Query(default="varsayilan")):
    key = cache_key("res_district", ilce_adi.lower(), senaryo)
...
@router.get("/res/district/{ilce_adi}/extremes", dependencies=[Depends(require_permission("raporlar"))])
...
# ── /api/res/scenarios ──────────────────────────────────────
@router.get("/res/scenarios", dependencies=[Depends(require_permission("atlas"))])
async def get_res_scenarios():
    key = "res_scenarios"
    cached = await stats_cache.get(key)
    if cached:
        return cached
